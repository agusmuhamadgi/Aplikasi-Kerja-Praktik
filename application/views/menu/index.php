...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-success btn-sm mb-3" data-toggle="modal" data-target="#menuModal"><i class="fas fa-plus fa-sm"></i> Tambah Menu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="" data-toggle="modal" data-target="#edit<?= $m['id'] ?>" class="badge badge-info"><i class="fas fa-edit"></i></a>
                                ...
                                <!-- Hapus-->
                                <a class="badge badge-danger" onclick="javascript: return confirm ('Anda yakin ingin menghapus ?')" href="<?= base_url('menu/hapus/' . $m['id']) ?>"><i class="fas fa-trash "></i></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
