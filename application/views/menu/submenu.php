...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg">
            ...
            <a href="" class="btn btn-success btn-sm mb-3" data-toggle="modal" data-target="#SubmenuModal"><i class="fas fa-plus fa-sm"></i> Tambah Sub Menu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($submenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="" data-toggle="modal" data-target="#editsub<?= $sm['id'] ?>" class="badge badge-info"><i class="fas fa-edit"></i></a>
                                <!-- Modal Edit-->
                                ...
                                <!-- Hapus-->
                                <a class="badge badge-danger" onclick="javascript: return confirm ('Anda yakin ingin menghapus ?')" href="<?= base_url('menu/hapus_sub/' . $sm['id']) ?>"><i class="fas fa-trash "></i></a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
